...
export const mageTwoHorizonsPrimaryFr = {
  ...
  prompt_nodes: [
    ...
    // --- ACT 1: 6 new prompts (total 8 with p01, p02) ---
    {
      prompt_id: 'mage-p13-character-sheet',
      act_id: 'act-1',
      node_type: 'ChallengeNode',
      title: 'Le profil du Mage',
      prompt_text: 'Ouvre ton grimoire et examine ton profil. Quelles sont tes competences de depart pour comprendre le mouvement?',
      prerequisites: ['mage-p01-sky-door'],
      mandatory: true,
      capability_refs: ['builder:character-sheet'],
      evidence_kind: 'observation',
    },
    {
      prompt_id: 'mage-p14-inventory-check',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Fouille du sac',
      prompt_text: 'Verifie les objets dans ton inventaire. As-tu la boussole des forces?',
      prerequisites: ['mage-p13-character-sheet'],
      mandatory: false,
      capability_refs: ['builder:inventory'],
      evidence_kind: 'observation',
    },
    {
      prompt_id: 'mage-p15-ascii-sky',
      act_id: 'act-1',
      node_type: 'ChoiceNode',
      title: 'L horizon lointain',
      prompt_text: 'Regarde le ciel en ASCII. Vers quelle constellation souhaites-tu orienter ta premiere experience?',
      prerequisites: ['mage-p01-sky-door'],
      mandatory: false,
      capability_refs: ['builder:ascii-sky-map'],
      evidence_kind: 'declared-choice',
    },
    {
      prompt_id: 'mage-p16-wind-roll',
      act_id: 'act-1',
      node_type: 'ChoiceNode',
      title: 'Le vent se leve',
      prompt_text: 'Lance le de deterministe pour determiner la force du vent qui souffle sur la plaine aujourd hui.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:deterministic-die'],
      evidence_kind: 'declared-choice',
    ...
    {
      prompt_id: 'mage-p17-notebook-log',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Journal de bord',
      prompt_text: 'Prends des notes sur tes premieres observations du vent et du ciel dans ton carnet.',
      prerequisites: ['mage-p16-wind-roll'],
      mandatory: false,
      capability_refs: ['colab:notebook'],
      evidence_kind: 'observation',
    },
    {
      prompt_id: 'mage-p18-spellbook-origin',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'L origine du Grimoire',
      prompt_text: 'Qui a ecrit ce grimoire? Examine les archives pour trouver la source de tes connaissances.',
      prerequisites: ['mage-p13-character-sheet'],
      mandatory: false,
      capability_refs: ['builder:provenance-registry'],
      evidence_kind: 'observation',
    },
    // --- ACT 2: 5 new prompts (total 8 with p03, p04, p10) ---
    {
      prompt_id: 'mage-p19-friction-block',
      act_id: 'act-2',
      node_type: 'ChallengeNode',
      title: 'Le sort de Frottement',
      prompt_text: 'Construis un bloc de force representant le frottement rugueux du sol.',
      prerequisites: ['mage-p03-build-force'],
      mandatory: true,
      capability_refs: ['builder:force-block'],
      evidence_kind: 'algorithm-artifact',
    },
    {
      prompt_id: 'mage-p20-gravity-isolated',
      act_id: 'act-2',
      node_type: 'ChallengeNode',
      title: 'Chute libre',
      prompt_text: 'Isole la gravite et lance une trajectoire sans aucune autre force pour observer la chute.',
      prerequisites: ['mage-p04-run-path'],
      mandatory: false,
      capability_refs: ['builder:trajectory-lab'],
      evidence_kind: 'execution-receipt',
    },
    {
      prompt_id: 'mage-p21-first-receipt',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Recu de l experience',
      prompt_text: 'Consulte le recu de ton dernier lancer. Les chiffres correspondent-ils a tes attentes?',
      prerequisites: ['mage-p04-run-path'],
      mandatory: false,
      capability_refs: ['builder:artifact-receipt'],
      evidence_kind: 'execution-receipt',
    },
    {
      prompt_id: 'mage-p22-calculation-fix',
      act_id: 'act-2',
      node_type: 'ChallengeNode',
      title: 'Ajustement des cadrans',
      prompt_text: 'La trajectoire devie trop a gauche. Ouvre le panneau de debogage et corrige la variable X.',
      prerequisites: ['mage-p19-friction-block'],
      mandatory: false,
      capability_refs: ['builder:debug-panel'],
      evidence_kind: 'debugging',
    },
    {
      prompt_id: 'mage-p23-random-mass',
      act_id: 'act-2',
      node_type: 'ChoiceNode',
      title: 'Poids surprise',
      prompt_text: 'Utilise le de pour choisir au hasard la masse du prochain projectile. Comment cela va-t-il affecter l elan?',
      prerequisites: ['mage-p20-gravity-isolated'],
      mandatory: false,
      capability_refs: ['builder:deterministic-die'],
      evidence_kind: 'declared-choice',
    },
    // --- ACT 3: 5 new prompts (total 8 with p05, p06, p11) ---
    {
      prompt_id: 'mage-p24-model-compare',
      act_id: 'act-3',
      node_type: 'ChallengeNode',
      title: 'Le duel des forces',
      prompt_text: 'Compare la trajectoire de l objet avec frottement et sans frottement. Quelle est la principale difference?',
      prerequisites: ['mage-p05-change-one-thing', 'mage-p19-friction-block'],
      mandatory: true,
      capability_refs: ['builder:model-comparison'],
      evidence_kind: 'transfer',
    },
    {
      prompt_id: 'mage-p25-combined-forces',
      act_id: 'act-3',
      node_type: 'ChallengeNode',
      title: 'Harmonie de puissance',
      prompt_text: 'Cree un bloc de force qui combine la poussee magique et la gravite en une seule formule.',
      prerequisites: ['mage-p24-model-compare'],
      mandatory: false,
      capability_refs: ['builder:force-block'],
      evidence_kind: 'algorithm-artifact',
    },
    {
      prompt_id: 'mage-p26-steep-angle',
      act_id: 'act-3',
      node_type: 'ChallengeNode',
      title: 'Tir en cloche',
      prompt_text: 'Modifie l angle de tir pour qu il soit tres abrupt. Observe la nouvelle courbe dans le labo.',
      prerequisites: ['mage-p05-change-one-thing'],
      mandatory: false,
      capability_refs: ['builder:trajectory-lab'],
      evidence_kind: 'transfer',
    ...
    {
      prompt_id: 'mage-p27-qbit-angle-help',
      act_id: 'act-3',
      node_type: 'ChoiceNode',
      title: 'Conseil de Qbit',
      prompt_text: 'Demande a Qbit comment calculer l apogee d une parabole.',
      prerequisites: ['mage-p26-steep-angle'],
      mandatory: false,
      capability_refs: ['qbit:bounded-help'],
      evidence_kind: 'assistance',
    },
    {
      prompt_id: 'mage-p28-speed-limit',
      act_id: 'act-3',
      node_type: 'ConvergenceNode',
      title: 'La limite de vitesse',
      prompt_text: 'Que se passe-t-il si la vitesse initiale est enorme? Identifie ou le modele simple commence a faire des erreurs.',
      prerequisites: ['mage-p05-change-one-thing'],
      mandatory: false,
      capability_refs: ['builder:model-boundary'],
      evidence_kind: 'bounded-explanation',
    },
    // --- ACT 4: 5 new prompts (total 8 with p07, p08, p09) ---
    {
      prompt_id: 'mage-p29-newton-vs-curve',
      act_id: 'act-4',
      node_type: 'ConvergenceNode',
      title: 'Le choc des modeles',
      prompt_text: 'Compare ton modele de trajectoire plate avec le modele de la Terre ronde. Remarques-tu la limite de la theorie de Newton ici?',
      prerequisites: ['mage-p07-newton-limit'],
      mandatory: true,
      capability_refs: ['builder:model-comparison'],
      evidence_kind: 'model-limit',
    ...
    {
      prompt_id: 'mage-p30-ancient-scholars',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Les savants d antan',
      prompt_text: 'Fais des recherches sur les premiers mages qui ont remarque que le sol etait courbe.',
      prerequisites: ['mage-p29-newton-vs-curve'],
      mandatory: false,
      capability_refs: ['builder:provenance-registry'],
      evidence_kind: 'fiction-boundary',
    },
    {
      prompt_id: 'mage-p31-edge-glitch',
      act_id: 'act-4',
      node_type: 'ChallengeNode',
      title: 'Le bug de l horizon',
      prompt_text: 'La simulation tremble pres des bords. Utilise le panneau de debogage pour stabiliser l affichage de la courbe.',
      prerequisites: ['mage-p07-newton-limit'],
      mandatory: false,
      capability_refs: ['builder:debug-panel'],
      evidence_kind: 'debugging',
    ...
    {
      prompt_id: 'mage-p32-shifting-stars',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'L illusion des etoiles',
      prompt_text: 'Observe la carte ASCII du ciel lointain. Les etoiles semblent bouger differemment a cause de la gravite!',
      prerequisites: ['mage-p07-newton-limit'],
      mandatory: false,
      capability_refs: ['builder:ascii-sky-map'],
      evidence_kind: 'observation',
    ...
    {
      prompt_id: 'mage-p33-collect-proof',
      act_id: 'act-4',
      node_type: 'MilestoneNode',
      title: 'La preuve ultime',
      prompt_text: 'Recupere ton jeton de completion attestant que tu as decouvert la limite du monde plat.',
      prerequisites: ['mage-p09-first-token', 'mage-p29-newton-vs-curve'],
      mandatory: true,
      capability_refs: ['builder:artifact-receipt'],
      evidence_kind: 'first-proof',
    },
    // --- ACT 5: 7 new prompts (total 8 with p12) ---
    {
      prompt_id: 'mage-p34-master-title',
      act_id: 'act-5',
      node_type: 'FinaleNode',
      title: 'Titre de Maitre',
      prompt_text: 'Mets a jour ton profil pour y inscrire ton nouveau titre: Mage des Deux Horizons.',
      prerequisites: ['mage-p12-finale'],
      mandatory: true,
      capability_refs: ['builder:character-sheet'],
      evidence_kind: 'reflection',
    },
    {
      prompt_id: 'mage-p35-final-journal',
      act_id: 'act-5',
      node_type: 'FinaleNode',
      title: 'Memoires de voyage',
      prompt_text: 'Ecris un dernier paragraphe dans ton carnet expliquant ce que tu as appris sur le mouvement et la gravite.',
      prerequisites: ['mage-p12-finale'],
      mandatory: true,
      capability_refs: ['colab:notebook'],
      evidence_kind: 'reflection',
    ...
    {
      prompt_id: 'mage-p36-inventory-review',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Revue du materiel',
      prompt_text: 'Regarde ton inventaire. Tous les blocs de force accumules y sont ranges en securite.',
      prerequisites: ['mage-p35-final-journal'],
      mandatory: false,
      capability_refs: ['builder:inventory'],
      evidence_kind: 'observation',
    },
    {
      prompt_id: 'mage-p37-epilogue-roll',
      act_id: 'act-5',
      node_type: 'ChoiceNode',
      title: 'Le prochain defi',
      prompt_text: 'Lance le de pour decouvrir vers quelle nouvelle region d apprentissage tu voyageras demain.',
      prerequisites: ['mage-p12-finale'],
      mandatory: false,
      capability_refs: ['builder:deterministic-die'],
      evidence_kind: 'declared-choice',
    ...
    {
      prompt_id: 'mage-p38-final-thoughts',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Reflexion silencieuse',
      prompt_text: 'Un moment de calme pour repenser aux lois de la physique qui gouvernent notre monde.',
      prerequisites: ['mage-p12-finale'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
      evidence_kind: 'bounded-explanation',
    },
    {
      prompt_id: 'mage-p39-future-model',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Au-dela de Newton',
      prompt_text: 'Tu realises qu il faudra un jour un modele encore plus complexe pour aller plus loin dans l espace.',
      prerequisites: ['mage-p34-master-title'],
      mandatory: false,
      capability_refs: ['builder:model-boundary'],
      evidence_kind: 'model-limit',
    },
    {
      prompt_id: 'mage-p40-goodbye-qbit',
      act_id: 'act-5',
      node_type: 'FinaleNode',
      title: 'Au revoir Qbit',
      prompt_text: 'Remercie Qbit pour son aide tout au long de cette grande aventure.',
      prerequisites: ['mage-p37-epilogue-roll'],
      mandatory: false,
      capability_refs: ['qbit:bounded-help'],
      evidence_kind: 'reflection',
    },
...
export const mageMissionEnvelope = {
  ...
  required_prompt_ids: ['mage-p01-sky-door', 'mage-p02-first-vector', 'mage-p03-build-force', 'mage-p04-run-path', 'mage-p05-change-one-thing', 'mage-p07-newton-limit', 'mage-p09-first-token', 'mage-p12-finale', 'mage-p13-character-sheet', 'mage-p19-friction-block', 'mage-p24-model-compare', 'mage-p29-newton-vs-curve', 'mage-p33-collect-proof', 'mage-p34-master-title', 'mage-p35-final-journal'],
  optional_prompt_ids: ['mage-p06-four-forces', 'mage-p08-riemann-map', 'mage-p10-help-request', 'mage-p11-repair', 'mage-p14-inventory-check', 'mage-p15-ascii-sky', 'mage-p16-wind-roll', 'mage-p17-notebook-log', 'mage-p18-spellbook-origin', 'mage-p20-gravity-isolated', 'mage-p21-first-receipt', 'mage-p22-calculation-fix', 'mage-p23-random-mass', 'mage-p25-combined-forces', 'mage-p26-steep-angle', 'mage-p27-qbit-angle-help', 'mage-p28-speed-limit', 'mage-p30-ancient-scholars', 'mage-p31-edge-glitch', 'mage-p32-shifting-stars', 'mage-p36-inventory-review', 'mage-p37-epilogue-roll', 'mage-p38-final-thoughts', 'mage-p39-future-model', 'mage-p40-goodbye-qbit'],
