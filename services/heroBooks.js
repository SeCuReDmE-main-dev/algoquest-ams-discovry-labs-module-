...
export const mageTwoHorizonsPrimaryFr = {
  ...
  prompt_nodes: [
    ...
    {
      prompt_id: 'mage-p13-extra-13',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 13',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
    ...
    {
      prompt_id: 'mage-p14-extra-14',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 14',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p15-extra-15',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 15',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p16-extra-16',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 16',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p17-extra-17',
      act_id: 'act-1',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 17',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p18-extra-18',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 18',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p19-extra-19',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 19',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p20-extra-20',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 20',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p21-extra-21',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 21',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p22-extra-22',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 22',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p23-extra-23',
      act_id: 'act-2',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 23',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p24-extra-24',
      act_id: 'act-3',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 24',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p25-extra-25',
      act_id: 'act-3',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 25',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p26-extra-26',
      act_id: 'act-3',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 26',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p27-extra-27',
      act_id: 'act-3',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 27',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p28-extra-28',
      act_id: 'act-3',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 28',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p29-extra-29',
      act_id: 'act-3',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 29',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p30-extra-30',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 30',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p31-extra-31',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 31',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p32-extra-32',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 32',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p33-extra-33',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 33',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p34-extra-34',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 34',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p35-extra-35',
      act_id: 'act-4',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 35',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p36-extra-36',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 36',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p37-extra-37',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 37',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p38-extra-38',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 38',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p39-extra-39',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 39',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
    ...
    {
      prompt_id: 'mage-p40-extra-40',
      act_id: 'act-5',
      node_type: 'OptionalDiscoveryNode',
      title: 'Quete optionnelle 40',
      prompt_text: 'Une quete exploratoire supplementaire pour consolider les acquis.',
      prerequisites: ['mage-p02-first-vector'],
      mandatory: false,
      capability_refs: ['builder:text-fallback'],
...
export const mageMissionEnvelope = {
  ...
  optional_prompt_ids: ['mage-p06-four-forces', 'mage-p08-riemann-map', 'mage-p10-help-request', 'mage-p11-repair', 'mage-p13-extra-13', 'mage-p14-extra-14', 'mage-p15-extra-15', 'mage-p16-extra-16', 'mage-p17-extra-17', 'mage-p18-extra-18', 'mage-p19-extra-19', 'mage-p20-extra-20', 'mage-p21-extra-21', 'mage-p22-extra-22', 'mage-p23-extra-23', 'mage-p24-extra-24', 'mage-p25-extra-25', 'mage-p26-extra-26', 'mage-p27-extra-27', 'mage-p28-extra-28', 'mage-p29-extra-29', 'mage-p30-extra-30', 'mage-p31-extra-31', 'mage-p32-extra-32', 'mage-p33-extra-33', 'mage-p34-extra-34', 'mage-p35-extra-35', 'mage-p36-extra-36', 'mage-p37-extra-37', 'mage-p38-extra-38', 'mage-p39-extra-39', 'mage-p40-extra-40'],
