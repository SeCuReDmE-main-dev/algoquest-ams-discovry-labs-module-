...
Project-specific focus: Supervised algorithm discovery, learner-facing safety, deterministic QBit companion behavior, and separation between the React interface and external services.
